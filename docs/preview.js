...
},
{
	...
	msgstr: ``,
	klei: `Наряд \\"Дополнительное время\\"`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Дубликанту в этих перчатках как-то раз дали пять целых три раза за день.`,
},
{
	msgctxt: "STRINGS.BLUEPRINTS.PERMIT_GLOVES_HOCKEY_07.NAME",
	msgid: `Hat-Trick Gloves`,
	msgstr: ``,
	klei: `Перчатки \\"Хет-трик\\"`,
},
{
	...
	msgstr: ``,
	klei: `Чтобы руки не замерзли, когда приходится ждать.`,
},
{
	msgctxt: "STRINGS.BLUEPRINTS.PERMIT_GLOVES_HOCKEY_08.NAME",
	msgid: `Overtime Gloves`,
	msgstr: ``,
	klei: `Перчатки \\"Дополнительное время\\"`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Да, они могли бы быть удобнее, зато как хорошо на них видно пятна!`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Рассказ об этом улове с каждым разом становится все невероятнее.`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Судя по масштабу, это существо и его друг были внушительных размеров.`,
},
{
	msgctxt: "STRINGS.BLUEPRINTS.PERMIT_PAINTING_WIDE_ART_CERES_A.NAME",
	msgid: `Babe the Blue Flox`,
	msgstr: ``,
	klei: `Голубой лисень Бэйб`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Часто надевают с перчатками из комплекта, чтобы <i>все</i> видели, кто тут лучший игрок.`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Это строение работает на полную мощность`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `
Уровень <style=\\"KKeyword\\">света</style> в этом строении постепенно повышается\\n
\\n
Если оно и дальше будет получать достаточно <style=\\"KKeyword\\">жидкости</style> и <style=\\"KKeyword\\">энергии</style>, максимальная яркость будет достигнута через {0}`,
},
{
...
\\n
Оно начнет заряжаться, когда получит достаточно <style=\\"KKeyword\\">жидкости</style> и <style=\\"KKeyword\\">энергии</style>`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `
Это строение вырабатывает меньше <style=\\"KKeyword\\">света</style>, потому что ему не хватает <style=\\"KKeyword\\">жидкости</style> и <style=\\"KKeyword\\">энергии</style>\\n
\\n
Когда строение израсходует запасы, оно отключится`,
},
{
	...
	msgstr: ``,
	klei: `Результат на выходе зависит от изначальной температуры материала.`,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.GEOTHERMALCONTROLLER.EFFECT",
	msgid: `Uses <link=\\"HEAT\\">Heat</link> from the planet's core to dramatically increase the temperature of <link=\\"ELEMENTSLIQUID\\">Liquid</link> inputs.\\n\\nMaterials will be emitted at connected Geo Vents.`,
	msgstr: ``,
	klei: `
Использует <link=\\"HEAT\\">жар</link> планетарного ядра для резкого повышения температуры вливаемой <link=\\"ELEMENTSLIQUID\\">жидкости</link>.\\n
\\n
Нагретые материалы выходят из присоединенных геоклапанов.`,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.GEOTHERMALVENT.BLOCKED_DESC",
	msgid: `Blocked geo vents can be cleared using <link=\\"ELEMENTSLIQUID\\">liquids</link> that are hot enough to melt <link=\\"LEAD\\">Lead</link>.`,
	msgstr: ``,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.GEOTHERMALVENT.DESC",
	msgid: `Geo vents must finish their current emission before accepting new materials.`,
	msgstr: ``,
	klei: `Добавлять новые материалы можно только после того, как геоклапаны вывели имеющиеся.`,
},
{
	...
	msgstr: ``,
	klei: `Дает материалы высокой <link=\\"HEAT\\">температуры</link>, нагретые геотермальным тепловым насосом.`,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.GEOTHERMALVENT.LOGIC_PORT",
	msgid: `Material Content Monitor`,
	msgstr: ``,
	klei: `Контроль содержимого`,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.GEOTHERMALVENT.LOGIC_PORT_ACTIVE",
	msgid: `Sends a <b><style=\\"logic_on\\">Green Signal</style></b> when geo vent has materials to emit`,
	msgstr: ``,
	klei: `Отправляет <b><style=\\"logic_on\\">зеленый сигнал</style></b>, когда геоклапаны готовы выпустить материалы`,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.GEOTHERMALVENT.LOGIC_PORT_INACTIVE",
...
},
{
	...
	msgstr: ``,
	klei: `Ртутным потолочным светильникам требуется время, чтобы достичь максимальной яркости, но, когда разгорятся... вау!`,
},
{
	...
	msgstr: ``,
	klei: `
Использует <link=\\"MERCURY\\">ртуть</link> и <link=\\"POWER\\">энергию</link> для производства <link=\\"LIGHT\\">света</link>.\\n
\\n
Свет снижает стресс дубликантов, а также требуется для роста некоторых растений.`,
},
{
	msgctxt: "STRINGS.BUILDINGS.PREFABS.MERCURYCEILINGLIGHT.NAME",
	msgid: `<link=\\"MERCURYCEILINGLIGHT\\">Mercury Ceiling Light</link>`,
	msgstr: ``,
	klei: `<link=\\"MERCURYCEILINGLIGHT\\">Ртутный потолочный светильник</link>`,
},
{
...
{
	msgctxt: "STRINGS.CLUSTER_NAMES.CERES_CLASSIC_SHATTERED_CLUSTER.NAME",
	msgid: `Blasted Ceres Cluster`,
	msgstr: ``,
},
{
...
\\n
Поехали. Кхм. Тестирование идет в соответствии с планом. Результаты превзошли все наши ожидания, в особенности в отношении температурного порога.\\n
\\n
...
Так вот.\\n
\\n
Сначала мы влили двенадцать тонн солоноватой грунтовой воды, охлажденной до шестидесяти пяти градусов.\\n
\\n
Мы получили чистый пар, а также почву, соль и микроэлементы. Как и ожидалось.\\n
\\n
Ну вот, значит. Теперь спускаем все из системы... Повышаем температуру в водном баке и прогоняем на двухстах градусах.\\n
\\n
(Шум жидкости в трубах)\\n
\\n
Разгоняем пар, чтобы...\\n
\\n
(Негромкий металлический звон)\\n
\\n
Минутку, тут мусор какой-то попал...\\n
\\n
Нужно быть осторожными. Даже небольшие помехи в системе могут привести к катаст...\\n
\\n
Погодите, это что... <i>окисленное железо</i>?\\n
\\n
Но как же...\\n
\\n
Я ведь только температуру измен...\\n
\\n
Тащите сюда двенадцать тонн... эм-м, нефти!\\n
\\n
Сейчас же!\\n
\\n
Извините, я имею в виду \\"<i>пожалуйста</i>\\".\\n
\\n
[КОНЕЦ ЗАПИСИ]\\n
------------------\\n
[НАЧАЛО ЗАПИСИ]\\n
...
(Долгая пауза)\\n
\\n
(Звук выключающегося оборудования)\\n
\\n
...поверить не могу.\\n
\\n
[КОНЕЦ ЗАПИСИ]`,
...
{
	msgctxt: "STRINGS.CODEX.INVESTIGATIONS.DLC2_GEOTHERMALTESTING.SUBTITLE",
	msgid: `ENCRYPTION LEVEL: THREE`,
	msgstr: ``,
	klei: `УРОВЕНЬ ШИФРОВАНИЯ: ТРЕТИЙ`,
},
{
	msgctxt: "STRINGS.CODEX.INVESTIGATIONS.DLC2_GEOTHERMALTESTING.TITLE",
	msgid: `Technician's Notes`,
	msgstr: ``,
	klei: `Записи техника`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Отмените заказ на соединение труб`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.BUTTONS.CANCEL_UNCOVER_VENT_TITLE",
	msgid: `Cancel Uncover Vent`,
	msgstr: ``,
	klei: `Отменить открытие клапана`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.BUTTONS.CANCEL_UNCOVER_VENT_TOOLTIP",
	msgid: `Cancel uncover vent order`,
	msgstr: ``,
	klei: `Отмените заказ на открытие клапана`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Отсоедините этот геоклапан от геотермального теплового насоса {Hotkey}`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Выпустите <style=\\"KKeyword\\">жидкость</style> из геотермального теплового насоса через геоклапаны в первый раз`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.BUTTONS.INITIATE_FIRST_VENT_TITLE",
	msgid: `Activate Power Plant`,
	msgstr: ``,
	klei: `Управлять электростанцией`,
},
{
	...
	msgstr: ``,
	klei: `Ни один из присоединенных клапанов не готов принимать материалы`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Соедините элементы <style=\\"KKeyword\\">стальной</style> водопроводной системы в этом строении, чтобы оно заработало`,
},
{
...
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.MYLOGNAME",
	msgid: `Warm Regards`,
	msgstr: ``,
...
},
{
	...
	msgstr: ``,
	klei: `Геотермальная электростанция: запуск`,
},
{
	...
	msgstr: ``,
	klei: `Геотермальная электростанция готова к работе`,
},
{
	...
	msgstr: ``,
	klei: `Геотермальный тепловой насос: готов`,
},
{
	...
	msgstr: ``,
	klei: `Геотермальный тепловой насос готов принимать материалы`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.POPUPS.GEOPLANT_ERRUPTED_DESC",
	msgid: `My Duplicants have successfully cleared the obstructed geo vent!\\n\\nWe can now maximize the full potential of this formidable heat and power source...and perhaps experiment with input temperatures to produce more interesting secondary byproducts.\\n\\nMy Duplicants seem keen to commemorate this accomplishment by keeping the obstruction as something of a trophy.`,
	msgstr: ``,
	klei: `
Моим дубликантам удалось устранить засор, мешающий работе последнего геоклапана!\\n
\\n
Теперь мы можем использовать весь потенциал этого удивительного источника постоянного тепла и энергии. Применения этой технологии ограничиваются только нашими навыками.\\n
\\n
Мои дубликанты хотят увековечить эту победу: они решили сохранить собранный мусор в качестве трофея.`,
},
{
	...
	msgstr: ``,
	klei: `Выполнено: геотермальная электростанция`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.POPUPS.GEOTHERMAL_DISCOVERED_TITLE",
	msgid: `New Building: Geothermal Power Plant`,
	msgstr: ``,
	klei: `Новое строение: геотермальная электростанция`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.POPUPS.GEOTHERMAL_DISOCVERED_DESC",
	msgid: `An abandoned geothermal power plant has been discovered!\\n\\nMy scans indicate that this facility comprises multiple buildings located throughout the planet, with plumbing entrenched so deeply in the terrain that much of it is beyond our reach.\\n\\nMost of the accessible portions look quite functional.`,
	msgstr: ``,
	klei: `
Мы обнаружили заброшенную геотермальную электростанцию!\\n
\\n
Результаты сканирования показали, что это предприятие состоит из нескольких строений, расположенных в разных частях планеты. Они соединены трубами, которые пролегают так глубоко, что до многих из них практически невозможно добраться.\\n
\\n
Большинство частей трубопровода, к которым мы смогли получить доступ, выглядят рабочими.`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.POPUPS.GEOTHERMAL_PLANT_REPAIRED_DESC",
	msgid: `Success! My Duplicants have restored the plumbing system for the geothermal heat pump.\\n\\nWe can now use this building to pump liquids out to the connected geo vents. Constructing steam turbines at the venting sites will enable us to convert the resulting steam into power.\\n\\nThe vents also emit various byproducts. I'm sure I can find a use for them.`,
	msgstr: ``,
	klei: `
Успех! Геотермальный тепловой насос готов принимать, нагревать и выводить жидкости.\\n
\\n
Если мне удастся залить достаточно жидкости, чтобы она начала двигаться по трубам под собственным давлением, моя колония сможет получить значительное количество тепла и энергии... и, возможно, других ресурсов.`,
},
{
	...
	msgstr: ``,
	klei: `Отчет о прогрессе: геотермальная электростанция`,
},
{
	...
	msgstr: ``,
	klei: `Перекачайте <style=\\"KKeyword\\">жидкость</style> от геотермального теплового насоса к геоклапанам`,
},
{
	...
	msgstr: ``,
	klei: `Управлять геотермальной электростанцией`,
},
{
	...
	msgstr: ``,
	klei: `Обнаружьте строения геотермальной электростанции`,
},
{
	...
	msgstr: ``,
	klei: `Обнаружить геотермальную электростанцию`,
},
{
	...
	msgstr: ``,
	klei: `Соедините геотермальный тепловой насос с трубами`,
},
{
	...
	msgstr: ``,
	klei: `Соединить геотермальный насос с трубами`,
},
{
	...
	msgstr: ``,
	klei: `Прочистите засоренный геоклапан, чтобы повысить эффективность геотермальной электростанции до максимума`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.REQUIREMENTS.UNBLOCK_VENT_TITLE",
	msgid: `Clear Blocked Geo Vent`,
	msgstr: ``,
	klei: `Прочистить засоренный геоклапан`,
},
{
	...
	msgstr: ``,
	klei: `Включить <link=\\"unused\\">геотермальный тепловой насос</link>`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.SIDESCREENS.BRING_CONTROLLER_ONLINE_TOOLTIP",
	msgid: `Reconnect this building's <style=\\"KKeyword\\">Steel</style> pipes to restore functionality\\n\\nClick to show this building`,
	msgstr: ``,
	klei: `
Соедините <style=\\"KKeyword\\">стальные</style> трубы этого строения, чтобы оно снова заработало\\n
\\n
Щелкните, чтобы увидеть строение`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.SIDESCREENS.BRING_ONLINE_DESC",
	msgid: ``,
	msgstr: ``,
	klei: ``,
},
{
	...
	msgstr: ``,
	klei: `Получить доступ к электростанции`,
},
{
	...
	msgstr: ``,
	klei: `Включить: <link=\\"{Target}\\">{Name}</link>`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.SIDESCREENS.BRING_VENT_ONLINE_TOOLTIP",
	msgid: `Restore this vent's functionality\\n\\nClick to show this vent`,
	msgstr: ``,
	klei: `
Восстановите работу этого клапана\\n
\\n
Щелкните, чтобы увидеть клапан`,
},
{
	...
	msgstr: ``,
	klei: `Успешно нагрейте <style=\\"KKeyword\\">жидкость</style> с помощью геотермального теплового насоса в первый раз`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.SIDESCREENS.UTILIZE_GEOPLANT_TITLE",
	msgid: `Complete Inaugural Run`,
	msgstr: ``,
	klei: `Завершить первый прогон`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Нет подключенных геоклапанов`,
},
{
	...
	msgstr: ``,
	klei: `Для работы это строение нужно подключить как минимум к одному геоклапану`,
},
{
...
},
{
	...
	msgid: `One or more connected geo vents are currently unavailable\\n\\nAll connected geo vents must be ready in order for this building to function\\n\\nClick here to show this vent`,
	msgstr: ``,
	klei: `Чтобы это строение смогло принимать материалы, все присоединенные геоклапаны должны быть готовы`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Это устройство пока не запущено`,
},
{
	...
	msgstr: ``,
	klei: `Ожидается восстановление трубопровода`,
},
{
	...
	msgstr: ``,
	klei: `Ожидается дубликант, который восстановит эти трубы`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_STATUS_NAME",
	msgid: `Pressure: {Amount}`,
	msgstr: ``,
	klei: `Давление теплового насоса: {Amount}`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_STATUS_TOOLTIP",
	msgid: `When pressure reaches {Threshold}, this building's contents will be heated and pumped out to connected geo vents\\n\\nCurrent pressure: {Amount}/{Threshold}`,
	msgstr: ``,
	klei: `
Когда давление достигнет {Threshold}, содержимое этого строения нагреется и будет выпущено из присоединенных геоклапанов\\n
\\n
Текущее давление: {Amount}\\n
\\n
Щелкните, чтобы увидеть строение`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.CONTROLLER.STORAGE_TEMPERATURE_NAME",
	msgid: `Liquid Temperature: {Temp}`,
	msgstr: ``,
	klei: `Средняя температура: {Temp}`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `<style=\\"KKeyword\\">Труба</style> засорена, <style=\\"KKeyword\\">жидкость</style> или <style=\\"KKeyword\\">газ</style> не поступает к этому геоклапану`,
},
{
...
},
{
	...
	msgid: `This geo vent is disconnected from the geothermal heat pump\\n\\nIt cannot recieve material in its current state`,
	msgstr: ``,
	klei: `Этот геоклапан не присоединен к геотермальному тепловому насосу и не получает от него материалы`,
},
{
...
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.OVERPRESSURE_TOOLTIP",
	msgid: `High <style=\\"KKeyword\\">Liquid</style> or <style=\\"KKeyword\\">Gas</style> pressure in this area is preventing further emissions\\n\\nReduce pressure by pumping <style=\\"KKeyword\\">Liquids</style> or <style=\\"KKeyword\\">Gases</style> away or clearing more space\\n\\nClick here to show this vent`,
	msgstr: ``,
	klei: `
Высокое давление <style=\\"KKeyword\\">газа</style> или <style=\\"KKeyword\\">жидкости</style> в этой области препятствует дальнейшему выводу веществ\\n
\\n
Снизьте давление, откачав <style=\\"KKeyword\\">жидкость</style> или <style=\\"KKeyword\\">газ</style> или расчистив пространство\\n
\\n
Щелкните, чтобы увидеть клапан`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.PENDING_REVEAL_NAME",
	msgid: `Pending Uncover`,
	msgstr: ``,
	klei: `Ожидается открытие`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.PENDING_REVEAL_TOOLTIP",
	msgid: `A Duplicant will be by shortly to remove this grimy old tarp`,
	msgstr: ``,
	klei: `Скоро здесь появится дубликант, который снимет с клапана этот грязный старый брезент`,
},
{
...
},
{
	...
	msgid: `This geo vent is currently obstructed by a <style=\\"KKeyword\\">Lead</style> mass\\n\\nIt will become usable once the obstruction has been cleared by piping in liquids hot enough to melt it`,
	msgstr: ``,
	klei: `
Этот геоклапан забит <style=\\"KKeyword\\">твердыми</style> материалами\\n
\\n
Если прочистить засор, клапан снова заработает`,
},
{
...
},
{
	...
	msgstr: ``,
	klei: `Этот геоклапан готов принимать материалы`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.VENTING_NAME",
	msgid: `Venting: {Quantity} remaining`,
	msgstr: ``,
	klei: `Активен`,
},
{
	msgctxt: "STRINGS.COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.STATUSITEMS.VENT.VENTING_TOOLTIP",
	msgid: `This geo vent is currently emitting materials\\n\\nIt has {Quantity} of materials left to emit before this process is complete`,
	msgstr: ``,
	klei: `
В данный момент этот геоклапан выводит материалы\\n
\\n
Осталось вывести: {Quantity}\\n
\\n
Щелкните, чтобы увидеть клапан`,
},
{
...
},
{
	...
	msgid: `A snackable handful of crunchy beans.`,
	msgstr: ``,
	klei: `Горстка хрустящих бобов для перекуса.`,
},
{
	msgctxt: "STRINGS.ITEMS.FOOD.DEEPFRIEDNOSH.NAME",
	msgid: `<link=\\"DEEPFRIEDNOSH\\">Nosh Noms</link>`,
	msgstr: ``,
	klei: `<link=\\"DEEPFRIEDNOSH\\">Хрум-бобы</link>`,
},
{
	msgctxt: "STRINGS.ITEMS.FOOD.DEEPFRIEDNOSH.RECIPEDESC",
	msgid: `A crunchy stack of <link=\\"BEANPLANT\\">Nosh Beans</link> deep-fried in <link=\\"TALLOW\\">Tallow</link>.`,
	msgstr: ``,
	klei: `Хрустящие <link=\\"BEANPLANT\\">закусочные бобы</link>, обжаренные в <link=\\"TALLOW\\">жире</link>.`,
},
{
...
},
{
	...
	msgid: `Enable DLC content on this save?\\n\\nThis will create a new copy of the save game. It will no longer be possible to load this copy without the DLC enabled.`,
	msgstr: ``,
},
{
	msgctxt: "STRINGS.UI.FRONTEND.PAUSE_SCREEN.ADD_DLC_MENU.DLC_DISABLED_NOT_EDITABLE_TOOLTIP",
	msgid: `This save does not have content from the <b>{0}</b> DLC enabled`,
	msgstr: ``,
},
{
	msgctxt: "STRINGS.UI.FRONTEND.PAUSE_SCREEN.ADD_DLC_MENU.DLC_DISABLED_TOOLTIP",
	msgid: `This save does not currently have content from <b>{0}</b> DLC enabled \\n\\n<b>Click to enable it</b>`,
	msgstr: ``,
},
{
	msgctxt: "STRINGS.UI.FRONTEND.PAUSE_SCREEN.ADD_DLC_MENU.DLC_ENABLED_TOOLTIP",
	msgid: `This save has content from <b>{0}</b> DLC enabled`,
	msgstr: ``,
},
{
	msgctxt: "STRINGS.UI.KEEPSAKES.GEOTHERMAL_PLANT.DESCRIPTION",
	msgid: `A spectacular sample of organic material fossilized into lead.\\n\\nSome things really <i>do</i> get better with age.`,
	msgstr: ``,
	klei: `
Удивительный образец органического материала, превратившегося в свинец в результате окаменения.\\n
\\n
Какие-то вещи <i>и правда</i> с годами становятся лучше.`,
},
{
	msgctxt: "STRINGS.UI.KEEPSAKES.GEOTHERMAL_PLANT.NAME",
	msgid: `Shiny Coprolite`,
	msgstr: ``,
	klei: `Блестящий копролит`,
},
{
...
{
	msgctxt: "STRINGS.UI.UISIDESCREENS.RELATEDENTITIESSIDESCREEN.TITLE",
...
},
{
	...
	msgstr: ``,
	klei: `
Сильно поврежденные останки ледяного астероида с отрицательными температурами во всех областях.\\n
\\n
<smallcaps>Изучать морозную Цереру после взрыва особенно сложно, однако природные источники топлива того стоят.</smallcaps>`,
},
{
	msgctxt: "STRINGS.WORLDS.CERESBASEGAMESHATTERED.NAME",
	msgid: `Blasted Ceres`,
	msgstr: ``,
	klei: `Церера после взрыва`,
},
{
	msgctxt: "STRINGS.WORLDS.CERESCLASSICSHATTERED.DESCRIPTION",
	msgid: `The heavily damaged remnants of a frosty location with sub-zero temperatures throughout.\\n\\n<smallcaps>Exploring the rubble of Blasted Ceres's sub-zero temperatures is particularly challenging, yet natural fuel sources provide a valuable payoff.</smallcaps>`,
	msgstr: ``,
	klei: `
Сильно поврежденные останки ледяного астероида с отрицательными температурами во всех областях.\\n
...
{
	msgctxt: "STRINGS.WORLDS.CERESCLASSICSHATTERED.NAME",
	msgid: `Blasted Ceres`,
	msgstr: ``,
	klei: `Церера после взрыва`,
},
